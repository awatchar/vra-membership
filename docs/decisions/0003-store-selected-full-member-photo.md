...
- ภาพที่ผู้สมัครอัปโหลดเองยังต้องมีอย่างน้อย 300 × 400 พิกเซล ส่วน field `face` จาก iApp ยอมรับที่ขนาดจริงของ provider โดยไม่ upscale และไม่บังคับขั้นต่ำ เพราะการเพิ่มจำนวนพิกเซลไม่ได้เพิ่มรายละเอียดของภาพ
...
- ภาพ face จาก iApp อาจมีความละเอียดต่ำกว่าคำแนะนำสำหรับรูปอัปโหลด ผู้จัดการต้องใช้ preview ตามคุณภาพจริง; ระบบไม่อ้างว่าการ upscale ทำให้ภาพคมขึ้นและไม่ปิดทางสมัครหลังผู้สมัครยืนยันภาพที่ provider ให้มา
